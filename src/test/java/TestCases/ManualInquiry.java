...
public class ManualInquiry extends Base{
	
	public ManualInquiry(){
		super();
	}
	
  @Test (enabled=false)
  public void iAuditSampleScheduleRequestManualInquiry() throws Exception {
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from ManualInquiry where TestName='"+testName+"'");
...
/*
		  //validate the column labels for manual.
		  Thread.sleep(4000); 
...
*/
		  ...
		  sampleScheduleRequest.dataEntryForManualInquirySampleScheduleRequest(hm);
